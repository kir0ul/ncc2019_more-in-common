...
def gen_stats():
    ...
    return (
        ...
        min_date,
        max_date,
        int(df_tweets["retweet_count"].sum()),
        int(df_tweets["favorite_count"].sum()),
    )
...
def main():
    ...
    try:
        ...
        print(
            "Error: "
            + request
            + " is not a recognized request. Available requests are: rt_users, fav_users, gen_stats, top_hashtags"
        )
